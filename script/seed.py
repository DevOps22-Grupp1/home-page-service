...
insert_data(
    ...
    "users",
    [
        {"id": 1, "name": "Max Svensson", "email": "me@gmail.com"},
        {"id": 2, "name": "Jarl Svensson", "email": "js@gmail.com"},
        {
            "id": 3,
...
insert_data(
    ...
    [
        ...
        {"id": 4, "userid": 4, "productid": 5},
        {"id": 5, "userid": 5, "productid": 6},
        {"id": 6, "userid": 6, "productid": 4},
    ],
)
